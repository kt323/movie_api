...
let allowedOrigins = ['http://localhost:8080', 'https://cf-myflix-client.netlify.app', 'https://api.netlify.com/api/v1/badges/109bd433-80de-4a7f-8a74-16837584fc8d/deploy-status', 'http://localhost:1234', 'https://stunning-nasturtium-5878df.netlify.app'];
app.use(cors({
